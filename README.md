...
当前实现遵循 [RFCs/0000-project-scope.md](RFCs/0000-project-scope.md) 至 [RFCs/0139-deterministic-unicode-string-queries.md](RFCs/0139-deterministic-unicode-string-queries.md)；RFC 0134 的 class 构造、受限接收者、私有继承/`super` 与接收者绑定 `=>` 已完整实现，RFC 0139 开始交付固定 Unicode 语义的业务字符串标准库。
