...
当前实现遵循 [RFCs/0000-project-scope.md](RFCs/0000-project-scope.md) 至 [RFCs/0136-structured-error-values.md](RFCs/0136-structured-error-values.md)；已采纳但尚待 issue #121 实现的 class 契约见 [RFCs/0134-class-receivers-and-inheritance.md](RFCs/0134-class-receivers-and-inheritance.md)。
