...
当前实现遵循 [RFCs/0000-project-scope.md](RFCs/0000-project-scope.md) 至 [RFCs/0138-deterministic-script-json.md](RFCs/0138-deterministic-script-json.md)；RFC 0134 的 class 构造、受限接收者、私有继承/`super` 与接收者绑定 `=>` 已完整实现，详见 [RFCs/0134-class-receivers-and-inheritance.md](RFCs/0134-class-receivers-and-inheritance.md)。
