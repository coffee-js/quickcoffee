...
qbench --compare-qjs PATH emits a separate qcompare CLI comparison using the caller-supplied QuickJS path; it includes startup, parsing, compilation, and execution.
